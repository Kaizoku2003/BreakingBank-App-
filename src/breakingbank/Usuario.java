...
public class Usuario {
    ...
    public Usuario(String nombreCompleto, String telefono, String correo,
                   String direccion, String cedula, String password, double saldo) {
    ...
    public Usuario(String nombreCompleto, String telefono, String correo,
        ...
        this(nombreCompleto, telefono, correo, direccion, cedula, password, 0.0);
    }
    ...
    public static Usuario desdeLineaArchivo(String linea) {
        ...
        return new Usuario(nombre, telefono, correo, direccion, cedula, password, saldo);
    }
}
